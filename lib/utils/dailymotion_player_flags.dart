...
class DailymotionPlayerFlags {
  ...
  /// Creates [DailymotionPlayerFlags].
  const DailymotionPlayerFlags({
  ...
  /// Copies new values assigned to the [DailymotionPlayerFlags].
  DailymotionPlayerFlags copyWith({
    bool? hideControls,
    bool? autoPlay,
    bool? mute,

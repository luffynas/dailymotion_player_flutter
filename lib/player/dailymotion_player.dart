...
import '../utils/inherited_dailymotion_player.dart';
import '../widgets/duration_widgets.dart';
import '../widgets/full_screen_button.dart';
import '../widgets/live_bottom_bar.dart';
import '../widgets/play_pause_button.dart';
import '../widgets/progress_bar.dart';
import '../widgets/touch_shutter.dart';
import 'raw_dailymotion_player.dart';
...
class DailymotionPlayer extends StatefulWidget {
  ...
  /// A [DailymotionPlayerController] to control the player.
  ...
  ///
  /// Returns [DailymotionMetaData] for the video that has just ended playing.
  /// {@endtemplate}
...
class _DailymotionPlayerState extends State<DailymotionPlayer> {
  ...
  @override
  void didUpdateWidget(DailymotionPlayer oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Material(
      elevation: 0,
      color: Colors.black,
      child: InheritedDailymotionPlayer(
        ...
        children: [
          Transform.scale(
            scale: controller.value.isFullScreen
                ...
                : 1,
            child: RawDailymotionPlayer(
              key: widget.key,
              onEnded: (DailymotionMetaData metaData) {
